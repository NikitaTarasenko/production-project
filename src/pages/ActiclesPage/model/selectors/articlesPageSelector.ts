...
export const getArticlesPageWidth = (state: StateSchema) =>
    state.articlesPage?._windowWidth || 1200;
export const getArticlesPageHeight = (state: StateSchema) =>
    state.articlesPage?._windowHeight || 900;
